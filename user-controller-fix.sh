...
}' > tmp/Controllers/UserController.php

# Copy UserController to Docker container
docker cp tmp/Controllers/UserController.php phone-store-php-1:/var/www/html/src/Controllers/
